...
public class OBSFileStatus extends FileStatus {
   ...
   */
  public OBSFileStatus(boolean isemptydir,
                       Path path,
                       String owner) {
   ...
   * @param owner owner
   */
  public OBSFileStatus(long length, long modification_time, Path path,
   ...
   *
   * obs uses objects as "fake" directories, which are not updated to
