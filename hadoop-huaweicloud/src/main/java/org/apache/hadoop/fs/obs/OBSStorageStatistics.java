...
/**
 * Storage statistics for OBS.
 */
@InterfaceAudience.Private
@InterfaceStability.Evolving
public class OBSStorageStatistics extends StorageStatistics {
  private static final Logger LOG = OBSFileSystem.LOG;

  public static final String NAME = "OBSStorageStatistics";
  private final Map<Statistic, AtomicLong> opsCount =
      new EnumMap<>(Statistic.class);

  public OBSStorageStatistics() {
    super(NAME);
