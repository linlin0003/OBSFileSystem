...
/**
 * Class to aid logging in to OBS endpoints.
 * It is in OBS so that it can be used across all OBS filesystems.
 */
public final class OBSLoginHelper {
  private static final Logger LOG =
      LoggerFactory.getLogger(OBSLoginHelper.class);
  ...
  public static void checkPath(Configuration conf,
    ...
    throw new IllegalArgumentException(
        "Wrong FS " + OBSLoginHelper.toString(pathUri)
            + " -expected " + fsUri);
  }
