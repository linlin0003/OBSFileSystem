...
/**
 * Statistic which are collected in OBS.
 * These statistics are available at a low level in {@link OBSStorageStatistics}
 * and as metrics in {@link OBSInstrumentation}
 */
public enum Statistic {
  ...
  FRONT_END_FILES_DELETED("front_end_files_deleted",
          "Total number of files deleted from the object store."),
  ...
  FRONT_END_DIRECTORIES_DELETED("front_end_directories_deleted",
          "Total number of front-end directory deletes submitted to object store."),
  BATCH_DELETED("batch_deleted",
          "Total number of batch deletes submitted to object store."),
  FILES_RENAMED("files_renamed",
          "Total number of files renamed within the object store."),
  DIRECTORIES_RENAMED("directories_renamed",
          "Total number of directories renamed within the object store."),
  FRONT_END_FILES_RENAMED("front_end_files_renamed",
          "Total number of front end files renamed within the object store."),
  FRONT_END_DIRECTORIES_RENAMED("front_end_directories_renamed",
          "Total number of front end directories renamed within the object store."),
  FRONT_END_EXISTED_DIRECTORIES_RENAMED("front_end_existed_directories_renamed",
          "Total number of front end existed directories renamed within the object store."),
  LIST_OBJECTS_IN_RENAME("list_objects_in_rename",
          "Total number of listing objects in rename operation."),
