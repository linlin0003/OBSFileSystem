...
public class ITestOBSBlockOutputArray extends AbstractOBSTestBase {
  ...
  private void markAndResetDatablock(OBSDataBlocks.BlockFactory factory)
    ...
    OBSInstrumentation instrumentation =
        new OBSInstrumentation(new URI("obs://example"));
    OBSInstrumentation.OutputStreamStatistics outstats
        = instrumentation.newOutputStreamStatistics(null);
    OBSDataBlocks.DataBlock block = factory.create(1, BLOCK_SIZE, outstats);
