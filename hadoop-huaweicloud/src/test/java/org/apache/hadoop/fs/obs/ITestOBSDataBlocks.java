...
public class ITestOBSDataBlocks extends Assert {
  ...
  /**
   * Test the {@link OBSDataBlocks.ByteBufferBlockFactory}.
  ...
  public void testByteBufferIO() throws Throwable {
    try (OBSDataBlocks.ByteBufferBlockFactory factory =
             new OBSDataBlocks.ByteBufferBlockFactory(null)) {
      int limit = 128;
      OBSDataBlocks.ByteBufferBlockFactory.ByteBufferBlock block
      ...
      // now start the write
      OBSDataBlocks.BlockUploadData blockUploadData = block.startUpload();
      OBSDataBlocks.ByteBufferBlockFactory.ByteBufferBlock.ByteBufferInputStream
          stream =
          (OBSDataBlocks.ByteBufferBlockFactory.ByteBufferBlock.ByteBufferInputStream)
  ...
  private static void assertOutstandingBuffers(
      OBSDataBlocks.ByteBufferBlockFactory factory,
      int expectedCount) {
